...
def calculate_features(segment, window_size):
    features = []
    for start in range(0, len(segment) - window_size + 1, 8):
...
def extract_features_from_segments(directory, window_size=10, output_dir='exercise_wise_ml_pipelines/dribbling/features_output'):
...
segments_directory = 'exercise_wise_ml_pipelines/dribbling/segment_csvs'
