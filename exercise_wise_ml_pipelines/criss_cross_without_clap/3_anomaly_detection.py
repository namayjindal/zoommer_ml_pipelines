...
feature_dir = "exercise_wise_ml_pipelines/criss_cross_without_clap/features_output"
...
with open('exercise_wise_ml_pipelines/criss_cross_without_clap/criss_cross_without_clap_anomaly_detector.tflite', 'wb') as f:
