...
def extract_features_from_segments(directory, window_size=4, output_dir='exercise_wise_ml_pipelines/skipping/features_output'):
...
segments_directory = 'exercise_wise_ml_pipelines/skipping/segment_csvs'
