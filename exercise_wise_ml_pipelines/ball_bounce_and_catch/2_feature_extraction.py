...
def extract_features_from_segments(directory, window_size=8, output_dir='exercise_wise_ml_pipelines/ball_bounce_and_catch/features_output'):
...
segments_directory = 'exercise_wise_ml_pipelines/ball_bounce_and_catch/segment_csvs'
